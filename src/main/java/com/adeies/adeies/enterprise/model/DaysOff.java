...
//    @Column(name = "grief_leave")
//    private Integer griefLeave;
//    @Column(name = "student_leave")
//    private Integer studentLeave;
//    @Column(name = "election_leave")
//    private Integer electionLeave;
//    @Column(name = "court_attendance_leave")
//    private Integer courtAttendanceLeave;
//    @Column(name = "strike")
//    private Integer strike;
//    @Column(name = "union_leave")
