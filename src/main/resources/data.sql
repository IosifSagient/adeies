INSERT INTO adeies.public.days_off_definition (id, description, wording)
...
INSERT INTO adeies.public.department (id, description, wording)
...
-- USER: Lostrif
INSERT INTO adeies.public.employee_card (birth_date, department_id, id, area, first_name, last_name,
                                         marital_status, position)
VALUES ('1986-03-09 02:00:00.000000', 1, 1, 'Sth mana sou', 'Losif3', 'Sagient3',
        'eeeeeeeeeeeeeeeeeeeeeeeee', 'dev');

INSERT INTO adeies.public.users (role, credentials_expiry_date, employee_card_id, id, email,
                                 language,
                                 password)
...
INSERT INTO adeies.public.transactions (days, end_date, start_date, status, approved_by_id,
                                        definition_id,
                                        id, user_id, comment)
